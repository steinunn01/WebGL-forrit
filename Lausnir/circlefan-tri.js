...
//     Teikna nálgun á hring með TRIANGLES í stað TRIANGLE_FAN
//
...
function createCirclePoints( cent, rad, k )
{
    ...
    for( i=k-1; i>=0; i-- ) {
		points.push(cent);				// Setja miðpunktinn í fylkið
		points.push(p);					// Setja síðasta punkt á hringnum í fylkið
    	a = i*dAngle;
    	p = vec2( rad*Math.sin(a) + cent[0], rad*Math.cos(a) + cent[1] );
    	points.push(p);					// Setja næsta punkt á hringnum í fylkið
    }
}
